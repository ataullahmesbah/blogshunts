...
const TeamWork = () => {
    return (
        <div className='bg-blue-50'>
            <div className="container mx-auto p-2 pt-12 pb-12 flex flex-col-reverse lg:flex-row items-center justify-between lg:gap-16 md:gap-10">

                <div className="lg:w-1/2 mb-6 lg:mb-0">
                    <Image className='rounded-lg' src={teamwork} alt='hyascka team work' />
                </div>
